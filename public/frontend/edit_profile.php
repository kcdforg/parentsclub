                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="gender" name="gender" required
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors bg-white">
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="tel" id="phone" name="phone" required
                                       class="flex-1 px-4 py-3 border border-l-0 border-gray-300 rounded-r-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
